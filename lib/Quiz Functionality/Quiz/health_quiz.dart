...
class _HealthQuizState extends State<HealthQuiz> {
  ...
  List<String> topic = ["Mood","Psychological State","Personal Care","Physical State","Habits","Measures",];
  int index = 0;
  int _currentValue = 5;
  int ans1 = 0;
  int ans2 = 0;
        ...
        child: SafeArea(
          child: Container(
            ...
            child: Column(
              ...
              .doc(userId).collection("Health").doc(userId).set({
            "Q1": ans1,
            "Q2": ans2,
            "Q3": ans3,
            "Q4": ans4,
